...
const Snow = ({ className }: { className?: string }) => {
  ...
  return (
    ...
    >
      ...
      <main className="z-20 text-center px-4 animate-fade-in-up">
      ...
      <div className="absolute bottom-0 w-full h-[30vh] z-10">
        <svg
          ...
          className="absolute bottom-0 w-full h-full drop-shadow-[-20px_-20px_40px_rgba(255,255,255,0.5)]"
        >
          <path
            fill="#f8f9fa"
        ...
        >
          <div className="relative group cursor-pointer">
            <h2 className="text-7xl xs:text-8xl md:text-[12rem] font-black text-[#6b85b2] opacity-20 select-none tracking-tighter text-404">
              404
            </h2>

            <div className="absolute -right-12 -top-12 w-16 h-16 pointer-events-none decoration-404">
