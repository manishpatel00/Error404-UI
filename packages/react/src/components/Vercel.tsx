    ...
    >
      ...
      <div className="relative z-10 w-full max-w-2xl flex flex-col items-center">
        ...
        <div className="text-center mb-8 sm:mb-16">
          <h1 className="text-7xl sm:text-9xl font-bold tracking-tighter mb-4 animate-fade-in-up">
            404
          </h1>
          <p
        ...
        <div className="w-full bg-[#111] border border-white/10 rounded-lg p-6 font-mono text-sm mb-12 shadow-2xl">
          ...
          <div className="space-y-2">
            ...
            <span className="inline-block w-2 h-4 bg-white/40 ml-1 animate-blink" />
          </div>
        </div>
