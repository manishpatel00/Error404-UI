...
const StoneAge = ({ className }: { className?: string }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 right-[15%] opacity-10 select-none animate-float-up">
        <svg width="200" height="200" viewBox="0 0 200 200">
          <path d="M40 160 L80 40 L120 180 L160 80 L180 160 Z" fill="#4a3b2a" />
        </svg>
      </div>

      <div className="absolute bottom-20 left-[10%] opacity-10 select-none animate-float-up-large">
      ...
      <div className="relative z-10 w-full max-w-4xl flex flex-col items-center text-center animate-fade-in-up">
        <div className="relative mb-8">
          <div className="relative z-20 animate-rock">
            <img
        ...
        <div className="px-4">
          ...
          <p className="text-[#6b5844] text-lg sm:text-xl md:text-2xl mb-8 sm:mb-12 max-w-xl mx-auto font-medium">
            This endpoint hasn&apos;t been discovered yet. It&apos;s still in
            the early Jurassic.
          </p>
