    ...
    >
      ...
      <div className="relative z-10 w-full max-w-2xl animate-fade-slide-up">
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-[1.5rem] sm:rounded-[2.5rem] p-8 sm:p-12 md:p-20 text-center shadow-2xl overflow-hidden group">
          ...
          <div className="relative inline-block mb-6 sm:mb-8 animate-scale-in">
          ...
          <div className="animate-fade-slide-up-delayed">
            ...
            <p className="text-gray-400 text-base sm:text-lg mb-8 sm:mb-12 max-w-md mx-auto leading-relaxed">
              The page you are seeking has drifted beyond our reach. Let&apos;s
              navigate you back to solid ground.
            </p>
