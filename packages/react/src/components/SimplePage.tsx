...
const SimplePage = ({ className }: { className?: string }) => {
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[480px] text-center animate-fade-in-up">
        <div className="mb-8 sm:mb-12">
          <h1 className="text-[100px] xs:text-[120px] md:text-[160px] font-black tracking-tighter text-black dark:text-white leading-none select-none animate-scale-in">
            404
          </h1>
        ...
        <div className="space-y-4 sm:space-y-6 px-4">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-base sm:text-lg leading-relaxed max-w-sm mx-auto font-medium">
            The page you requested is currently unavailable. It may have been
