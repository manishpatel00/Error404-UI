  ...
  return (
    ...
    >
      ...
      <div className="z-10 w-full max-w-5xl flex flex-col items-center">
        ...
        <h1 className="text-3xl md:text-5xl font-bold text-[#2f8d46] mb-4 text-center animate-fade-in delay-100 px-4">
          Data Structure Not Found
        </h1>

        <p className="text-gray-600 text-center max-w-xl mb-8 sm:mb-12 text-base sm:text-lg animate-fade-in delay-200 px-4">
          Even the most efficient algorithms occasionally hit a null pointer.
          While we garbage collect this error, why not explore these popular
          topics?
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full mb-12 animate-fade-in delay-300">
          <Card
...
const Card = ({
  ...
  return (
    <div className="p-6 rounded-2xl border bg-white flex flex-col items-center text-center shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer group hover:-translate-y-2 hover:scale-[1.02]">
      <div
        className={`p-4 rounded-xl mb-4 transition-colors group-hover:scale-110 ${color}`}
      >
        {icon}
      </div>
