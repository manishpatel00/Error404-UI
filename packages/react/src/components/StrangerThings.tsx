  ...
  return (
    ...
    >
      <style jsx>{`
        ...
        .error-1-e {
          animation: slideRight 3s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }
        .error-2-r {
          animation: slideDown 4s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }
        .error-4-o {
          animation: slideLeft 3.5s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }
        .error-5-r {
          animation: slideLeft 3s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }
        .error-2-0 {
          animation: slideUp 4.5s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }
        ...
        .quote-wrapper {
          ...
          opacity: 0;
          animation: slideUpFadeIn 1.5s cubic-bezier(0.16, 1, 0.3, 1) 2.5s
            forwards;
        }
        ...
        .quote-bottom {
          ...
          font-weight: 700;
          opacity: 0;
          animation: slideUpFadeIn 1.5s cubic-bezier(0.16, 1, 0.3, 1) 3s
            forwards;
        }
      ...
      <main className="w-full h-full flex flex-col items-center justify-center space-y-8">
        <div
        ...
        >
          ...
          >
            ...
            <g fillRule="evenodd">
              ...
              <g className="top fill-none stroke-red-600 stroke-[2px] stroke-round stroke-linejoin-round">
                <use className="error-3-4" href="#error-3-4" />
                <use className="error-2-0" href="#error-2-0" />
                <use className="error-1-4" href="#error-1-4" />
                <use className="error-1-e" href="#error-1-e" />
                <use className="error-2-r" href="#error-2-r" />
                <use className="error-3-r" href="#error-3-r" />
                <use className="error-4-o" href="#error-4-o" />
                <use className="error-5-r" href="#error-5-r" />
                <use className="error-right" href="#error-right" />
                <use className="error-left" href="#error-left" />
                <use className="error-top" href="#error-top" />
              </g>
            </g>
          </svg>
        </div>
        ...
        <div className="w-full flex justify-center text-center">
          <div className="quote-wrapper">
            <span className="quote-top">Lost in the </span>
            <span className="quote-bottom">Upside Down..?</span>
          </div>
        </div>
