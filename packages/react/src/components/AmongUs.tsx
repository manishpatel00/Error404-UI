  ...
  return (
    ...
    >
      ...
      <div className="z-10 flex flex-col items-center text-center px-4 select-none">
        ...
        <div className="space-y-4 sm:space-y-6 fade-in-delayed">
          ...
          <p className="text-base sm:text-xl md:text-3xl text-white tracking-widest fade-in-delayed-2">
            <span className="text-red-600 font-bold px-1 sm:px-2">
              404-Page
            </span>{" "}
            was not An Impostor.
          </p>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          className="absolute w-32 md:w-56 h-auto animate-float-red"
          style={{ left: "-25%" }}
        >
          <Image
        ...
        <div
          className="absolute w-24 md:w-40 h-auto animate-float-blue"
          style={{ left: "-25%" }}
        >
          <Image
