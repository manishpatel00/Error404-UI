        ...
        <div className="relative z-20 flex flex-col items-center justify-center p-10 text-center space-y-8">
          ...
          <div className="max-w-md space-y-4">
            <h2 className="text-3xl font-bold tracking-tight leading-tight">
              Turn &quot;Page Not Found&quot; into &quot;Customer Found&quot;
            </h2>
            <p className="text-lg text-zinc-300 leading-relaxed text-balance">
              Don&apos;t let a broken link break your user&apos;s experience. Access your dashboard and start crafting 404 pages that retain, engage, and convert.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="relative mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[400px]">
          ...
          <div className="flex flex-col items-center justify-center min-h-[400px]">
            ...
            <Link
                ...
                className="mt-4 text-sm text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-200 hover:underline underline-offset-4"
            >
